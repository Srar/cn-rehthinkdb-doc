...
window.Typekit.config = {
    "a": "658049",
    "c": [".tk-inconsolata", "\"inconsolata\",sans-serif", ".freight-sans", "\"freight-sans-pro\",sans-serif"],
    "dl": "AAAArQAAAApK5iN9wCPYHQB-BvNHMrcwd1M2qQAAFjc",
    "f": "//use.typekit.net/c/4ff6f4/1w;freight-sans-pro,2,TJC:V:i4,TJ8:V:n3,TJB:V:n4,TJD:V:n5,TJG:V:n6,TJJ:V:n7;inconsolata,7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191,XH2:V:n5/{format}{/extras*}",
    "fc": [{
        "id": 126,
        "family": "inconsolata",
        "src": "/DocsPages/fonts/typekit_proxy/u0",
        "descriptors": {
            "weight": "500",
            "style": "normal",
    ...
    },
    {
        ...
        "src": "/DocsPages/fonts/typekit_proxy/u1",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "subset_id": 2
    ...
    },
    {
        "id": 13453,
        "family": "freight-sans-pro",
        "src": "/DocsPages/fonts/typekit_proxy/u2",
        "descriptors": {
            "weight": "400",
            "style": "italic",
            "subset_id": 2
    ...
    },
    {
        "id": 13454,
        "family": "freight-sans-pro",
        "src": "/DocsPages/fonts/typekit_proxy/u3",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "subset_id": 2
    ...
    },
    {
        "id": 13456,
        "family": "freight-sans-pro",
        "src": "/DocsPages/fonts/typekit_proxy/u4",
        "descriptors": {
            "weight": "300",
            "style": "normal",
            "subset_id": 2
    ...
    },
    {
        "id": 13458,
        "family": "freight-sans-pro",
        "src": "/DocsPages/fonts/typekit_proxy/u5",
        "descriptors": {
            "weight": "500",
            "style": "normal",
            "subset_id": 2
    ...
    },
    {
        "id": 13460,
        "family": "freight-sans-pro",
        "src": "/DocsPages/fonts/typekit_proxy/u6",
        "descriptors": {
            "weight": "600",
            "style": "normal",
            "subset_id": 2
    ...
    "fi": [126, 10954, 13453, 13454, 13456, 13458, 13460],
    "fn": ["freight-sans-pro", ["i4", "n3", "n4", "n5", "n6", "n7"], "inconsolata", ["n5"]],
    "hn": "/DocsPages/fonts/lmb6cah1.js",
    "ht": "tk",
    "js": "1.18.8",
    "kt": "lmb6cah",
    "l": "typekit",
...
/*{"k":"1.18.8","auto_updating":true,"last_published":"2015-07-15 18:35:18 UTC"}*/
; (function(window, document, undefined) {
    ...
    fa.prototype.has = function(a) {
        ...
        c = 0; c < this.i; c++) {
            var d;
            if (b) d = q(a & 4294967295, 3432918353),
            d = d << 15 | d >>> 17,
            d = q(d, 461845907),
            d ^= ga[c] || 0,
            d = d << 13 | d >>> 19,
    ...
    function xa(a) {
        ...
        c = a.j.b.offsetWidth,
        d; (d = b === a.g.serif && c === a.g["sans-serif"]) || (d = wa() && ya(a, b, c));
        ...
        if (!e && c) B(a.b);
            ...
            function(b) {
                ...
                if (null === S) if (window.FontFace) {
                    ...
                    S = e ? 42 < parseInt(e[1], 10) : !0
                } else S = !1;
                S ? c = new Aa(k(a.i, a), k(a.j, a), a.v, b, a.w, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u) : c = new va(k(a.i, a), k(a.j, a), a.v, b, a.w, d, "BESbswy\ue000\ue001\ue002\ue003\ue004\ue005\ue006", a.u);
                f.push(c)
            });
    ...
    function Ca(a) { ! --a.g && a.m && (a.o ? (a = a.b, a.i && z(a.g, [a.b.b("wf", "active")], [a.b.b("wf", "loading"), a.b.b("wf", "inactive")]), C(a, "active")) : B(a.b))
    };
    function T(a, b) {
        this.b = a;
        this.g = [];
    ...
    T.prototype.load = function(a, b, c) {
        ...
        if (this.i) {
            ...
            // if (!this.i.has(h)) {
            //     console.error('Typekit: the domain "' + h + '" isn\'t in the list of published domains for kit "' + this.o + '".');
            //     B(c);
            //     return
            // }
        }
    ...
    Z = 0; Z < X.length; Z++) W.m.b.push(new ma(X[Z].family, X[Z].src, X[Z].descriptors));
    if (n.dl) {
        var Ha = n.dl;
        try {
            W.i = new ha(Ha)
    ...
    n.kt && (W.o = n.kt);
    if (n.c) for (var p = 0; p < n.c.length; p += 2) W.g.push(new da);
        ...
        window.Typekit.load = function(a) {
            ...
            a.fontactive = function(a, b) {
                ...
                a: {
                    ...
                    h += "00";
                    for (var l = n.fc,
                    u = 0; u < l.length; u++) if (l[u].family === a && l[u].descriptors.weight === h && l[u].descriptors.style === g) {
                        g = l[u].id;
                        break a
                    }
                    g = 0
